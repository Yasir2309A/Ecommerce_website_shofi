    ...
    public partial class xyz : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_catogerys", x => x.cat_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_products_catogerys_cat_id",
                        column: x => x.cat_id,
                        principalTable: "catogerys",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    coustomer_password = table.Column<string>(type: "nvarchar(max)", nullable: false),
